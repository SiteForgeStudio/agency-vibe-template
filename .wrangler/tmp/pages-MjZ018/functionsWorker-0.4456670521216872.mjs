...
// utils/content-enhancement.js
function cleanString2(value) {
  return typeof value === "string" ? value.trim() : "";
}
__name(cleanString2, "cleanString");
...
__name(cleanString3, "cleanString");
...
function repairContactDetailsComboFacts(repaired, rawAnswer) {
  ...
  const push = /* @__PURE__ */ __name((fact_key, value, rationale) => {
...
function syncBusinessDraftFromEvidence({ blueprint, state }) {
  ...
  const fact = /* @__PURE__ */ __name((key) => blueprint.fact_registry?.[key]?.value, "fact");
...
function syncHeroDraftFromEvidence(draft, factRegistry, state) {
  const fact = /* @__PURE__ */ __name((key) => factRegistry?.[key]?.value, "fact");
...
function buildQuestionCandidates({ blueprint, previousPlan, lastAudit, state }) {
  ...
  for (const [decision, config] of Object.entries(decisionTargets)) {
    ...
    if (unresolvedFields.some((fk) => cleanString4(factRegistry[fk]?.status) === "prefilled_unverified")) {
      const orderIdx = /* @__PURE__ */ __name((fk) => {
...
function buildPricingFramingSentence(pi) {
  ...
  const frame = /* @__PURE__ */ __name((sentence, max = 340) => truncate2(cleanString4(sentence), max), "frame");
...
async function renderNextQuestion({
  ...
  const isFieldResolvedLocal = /* @__PURE__ */ __name((fieldKey) => isFactResolved(factRegistry?.[fieldKey], fieldKey), "isFieldResolvedLocal");
...
__name(normalizeState2, "normalizeState");
...
__name(hasMeaningfulValue2, "hasMeaningfulValue");
...
__name(firstNonEmpty2, "firstNonEmpty");
...
__name(buildHeroImageQuery2, "buildHeroImageQuery");
...
__name(hasMeaningfulValue3, "hasMeaningfulValue");
...
__name(normalizeCategory2, "normalizeCategory");
...
__name(inferCtaType2, "inferCtaType");
...
__name(buildHeroImageQuery3, "buildHeroImageQuery");
...
__name(buildGalleryImageQuery2, "buildGalleryImageQuery");
...
__name(computeSectionStatus2, "computeSectionStatus");
...
__name(evaluateBlueprintReadiness2, "evaluateBlueprintReadiness");
...
__name(extractJsonObject2, "extractJsonObject");
...
__name(extractJsonObject3, "extractJsonObject");
...
// ../../../.wrangler/tmp/pages-MjZ018/functionsRoutes-0.13764056688676618.mjs
var routes = [
  {
...
// ../../../.wrangler/tmp/bundle-THcS7s/middleware-insertion-facade.js
...
// ../../../.wrangler/tmp/bundle-THcS7s/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.4456670521216872.mjs.map
