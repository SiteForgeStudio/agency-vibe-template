function json(data, status = 200) {
  ...
  - Focus on local SEO, category fit, NAP consistency, and setup recommendations.
  ...
  - "recommended_primary_category" must be a real-world GBP-style business category, not a business model
  ...
  - "required_inputs_for_setup" should contain the most important items needed to create or improve the profile
  - "improvement_opportunities" should be practical and concise
  - Do not mention websites, schema, or Astro
  - Return JSON only
  `;
