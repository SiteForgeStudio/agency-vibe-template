...
**System anchor:** Intake architecture, contracts, and observability are defined in **`manifest.md` v2.2**; bump this spec’s version note when the preflight → `preflight_intelligence` handoff shape changes.
